...
// ISprocketService is an autogenerated mock type for the ISprocketService type
type ISprocketService struct {
	mock.Mock
}

// GetById provides a mock function with given fields: ctx, sprocketId
func (_m *ISprocketService) GetById(ctx context.Context, sprocketId int64) (*model.Sprocket, error) {
...
func (_m *ISprocketService) New(ctx context.Context, sprocket *model.Sprocket) (int64, error) {
...
func (_m *ISprocketService) Update(ctx context.Context, sprocket *model.Sprocket) error {
	ret := _m.Called(ctx, sprocket)
